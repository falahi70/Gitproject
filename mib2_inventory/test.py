...
targets = coresolution_handle.execute_cpl("""
                    ...
                    |   search      os  not in ("Windows", "ILO-HP", "Linux", "Hypervisor", "vCenter", "OA-HP", "OneView_HP", "EMC-OE")            
                    |   join            Type := left 
                                    ...
                                    [
                                        ...
                                        |fields         key             as  networkNodeKey,
                                                        ipAddress,
                                                        preferredConnection as credentialName
                                    ]            
                    |   eval        ipAddress   :=  longtoip(ipAddress)
                    |   fields      hostname,ipAddress,credentialName,hostname,os
...
def interfaceindex():
    ...
    print(targets_with_snmp_result)
    exit()
