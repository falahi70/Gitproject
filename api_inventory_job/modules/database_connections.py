...
class databaseConnection:
    ...
    def bulk2db(self, schema_name, table_name, data_list):
        ...
        input_file_handle = open(data_list, "r", encoding="utf-8", errors="replace")
        print(f"[!] Inserting DB. [InputFileName]: {data_list}")
    ...
    def get_column_names(self, schema_name, table_name):
        ...
        columns = [column[0] for column in column_names]
        return columns
