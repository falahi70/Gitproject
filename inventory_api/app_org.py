...
async def check_queue(request: Request,
    ...
    hostname_check_query = f"select * from asset_inventory.\"computerSystem\" where hostname='{user_hostname}' AND osfamily ='windows' AND createdtime > current_date - interval '1' day LIMIT 1"
