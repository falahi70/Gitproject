...
def main():
    # device_Discovery
    os.chdir("/CoreInspect/agents/device_Discovery")
    run_command("/root/.pyenv/shims/python3 deviceDiscovery.py", "/CoreInspect/agents/device_Discovery/device_Discovery.log")
